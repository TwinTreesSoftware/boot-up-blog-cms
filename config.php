...
//Настройки бд 
define( "DB_DSN", "mysql:host=localhost;dbname=db" ); //Имя базы данных и хост. Вводить в таком формате: mysql:host=тут хост;dbname=тут имя базы данных
define( "DB_USERNAME", "root" ); //Логин пользователя бд
define( "DB_PASSWORD", "" ); //Пароль пользователя бд

//Настроки патчей
define( "CLASS_PATH", "classes" ); //Патч с классами
define( "TEMPLATE_PATH", "templates" ); //Патч с шаблоном

//Максимальное количество записей на главной
define( "HOMEPAGE_NUM_ARTICLES", 5 );

//Настройки комментариев вконтакте
define( "VK_APIID", 0000000); //ApiId приложения вконтакте для комментариев
