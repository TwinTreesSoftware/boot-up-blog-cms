...
<?php } ?>
        ...
        <ul>
          ...
          <li>
            ...
            <textarea name="content" id="content" placeholder="The HTML content of the news" required maxlength="100000" style="height: 30em;"><?php echo htmlspecialchars( $results['article']->content )?></textarea>
          </li>
